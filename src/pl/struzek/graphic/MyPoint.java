...
public class MyPoint extends Point{
	...
	public boolean contains(int ix, int iy,double d) {
		pl.struzek.msketch.Point p = pl.struzek.msketch.Point.getDbPoint().get(this.id);
	...
	@Override
	public double getX() {
		return pl.struzek.msketch.Point.getDbPoint().get(this.id).getX();
	}

	@Override
	public double getY() {
		return pl.struzek.msketch.Point.getDbPoint().get(this.id).getY();
	}
