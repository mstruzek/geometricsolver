...
public class ConstraintDistance2Points extends Constraint {
	 ...
	 * @param L
	 */
	public ConstraintDistance2Points(Point K, Point L ,Parameter param){
		super(GeometricConstraintType.Distance2Points);
	...
	public static void main(String[] args) {
		...
		ConstraintDistance2Points con = new ConstraintDistance2Points(p1,p2 ,new Parameter(0.8));
		ConstraintDistance2Points con2 = new ConstraintDistance2Points(p1,p2 ,par);
