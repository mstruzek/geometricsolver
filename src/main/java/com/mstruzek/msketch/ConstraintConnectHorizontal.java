 ...
 * @author root
 */
public class ConstraintConnectHorizontal extends Constraint {
     ...
     */
    public ConstraintConnectHorizontal(int constId, Point K, Point L) {
        super(constId, GeometricConstraintType.ConnectHorizontal, true);
        //pobierz id
        k_id = K.id;
        l_id = L.id;
    }
