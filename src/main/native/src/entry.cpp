...
int main(int argc, char* args[]) 
{
    ...
    err = jni_registerParameterType(&env, eclass, 1, 10.0);
    ...
    err = jni_registerConstraintType(&env, eclass, 0, CONSTRAINT_TYPE_ID_FIX_POINT, 0, -1, -1, -1, -1, -7.121757e+02, 1.021186e+03);
    err = jni_registerConstraintType(&env, eclass, 1, CONSTRAINT_TYPE_ID_FIX_POINT, 3, -1, -1, -1, -1, -7.121757e+02, 2.621186e+03);
    err = jni_registerConstraintType(&env, eclass, 2, CONSTRAINT_TYPE_ID_FIX_POINT, 4, -1, -1, -1, -1, -2.336245e+03, 2.221186e+03);
    err = jni_registerConstraintType(&env, eclass, 3, CONSTRAINT_TYPE_ID_FIX_POINT, 7, -1, -1, -1, -1, 4.160031e+03, 2.221186e+03);
    err = jni_registerConstraintType(&env, eclass, 4, CONSTRAINT_TYPE_ID_LINES_PERPENDICULAR, 1, 2, 5, 6, -1, 0.000000e+00, 0.000000e+00);
    err = jni_registerConstraintType(&env, eclass, 5, CONSTRAINT_TYPE_ID_CONNECT_2_POINTS, 2, 5, -1, -1, -1, 0.000000e+00, 0.000000e+00);
    err = jni_registerConstraintType(&env, eclass, 6, CONSTRAINT_TYPE_ID_SET_HORIZONTAL, 6, 5, 0, 0, -1, 0.000000e+00, 0.000000e+00);
    err = jni_registerConstraintType(&env, eclass, 7, CONSTRAINT_TYPE_ID_FIX_POINT, 8, -1, -1, -1, -1, 1.746198e+03, 2.093574e+03);
    err = jni_registerConstraintType(&env, eclass, 8, CONSTRAINT_TYPE_ID_FIX_POINT, 11, -1, -1, -1, -1, 3.720609e+03, 2.412606e+03);
    err = jni_registerConstraintType(&env, eclass, 9, CONSTRAINT_TYPE_ID_CONNECT_2_POINTS, 6, 9, -1, -1, -1, 0.000000e+00, 0.000000e+00);
    err = jni_registerConstraintType(&env, eclass, 10, CONSTRAINT_TYPE_ID_FIX_POINT, 12, -1, -1, -1, -1, 2.535962e+03, 1.021186e+03);
    err = jni_registerConstraintType(&env, eclass, 11, CONSTRAINT_TYPE_ID_FIX_POINT, 15, -1, -1, -1, -1, 2.535962e+03, 2.621186e+03);
    err = jni_registerConstraintType(&env, eclass, 12, CONSTRAINT_TYPE_ID_FIX_POINT, 16, -1, -1, -1, -1, -2.336245e+03, 1.421186e+03);
    err = jni_registerConstraintType(&env, eclass, 13, CONSTRAINT_TYPE_ID_FIX_POINT, 19, -1, -1, -1, -1, 4.160031e+03, 1.421186e+03);
    err = jni_registerConstraintType(&env, eclass, 14, CONSTRAINT_TYPE_ID_LINES_PERPENDICULAR, 17, 18, 1, 2, -1, 0.000000e+00, 0.000000e+00);
    err = jni_registerConstraintType(&env, eclass, 15, CONSTRAINT_TYPE_ID_LINES_PERPENDICULAR, 18, 17, 13, 14, -1, 0.000000e+00, 0.000000e+00);
    err = jni_registerConstraintType(&env, eclass, 16, CONSTRAINT_TYPE_ID_CONNECT_2_POINTS, 1, 17, -1, -1, -1, 0.000000e+00, 0.000000e+00);
    err = jni_registerConstraintType(&env, eclass, 17, CONSTRAINT_TYPE_ID_CONNECT_2_POINTS, 18, 13, -1, -1, -1, 0.000000e+00, 0.000000e+00);
    err = jni_registerConstraintType(&env, eclass, 18, CONSTRAINT_TYPE_ID_CONNECT_2_POINTS, 6, 14, -1, -1, -1, 0.000000e+00, 0.000000e+00);
    err = jni_registerConstraintType(&env, eclass, 19, CONSTRAINT_TYPE_ID_FIX_POINT, 20, -1, -1, -1, -1, -1.511507e+03, 2.188290e+03);
    err = jni_registerConstraintType(&env, eclass, 20, CONSTRAINT_TYPE_ID_FIX_POINT, 23, -1, -1, -1, -1, 4.868205e+02, 2.270531e+03);
    err = jni_registerConstraintType(&env, eclass, 21, CONSTRAINT_TYPE_ID_CONNECT_2_POINTS, 2, 21, -1, -1, -1, 0.000000e+00, 0.000000e+00);
    err = jni_registerConstraintType(&env, eclass, 22, CONSTRAINT_TYPE_ID_EQUAL_LENGTH, 21, 22, 9, 10, -1, 0.000000e+00, 0.000000e+00);
    err = jni_registerConstraintType(&env, eclass, 23, CONSTRAINT_TYPE_ID_DISTANCE_2_POINTS, 9, 10, -1, -1, 0, 0.000000e+00, 0.000000e+00);
    err = jni_registerConstraintType(&env, eclass, 24, CONSTRAINT_TYPE_ID_PARAMETRIZED_LENGTH, 9, 10, 14, 13, 1, 0.000000e+00, 0.000000e+00);
